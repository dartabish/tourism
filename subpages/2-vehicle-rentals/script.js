  ...
  object.forEach(vehicle => {
    ...
    let cardContent = `
            ...
            <div class="modal-dialog modal-dialog-centered">
              ...
              <form  action="https://formsubmit.co/kingsback367@gmail.com" method="POST" id="bookingForm${vehicle.id}" class="booking-form" data-vehicle-id="${vehicle.id}"  method="POST">
